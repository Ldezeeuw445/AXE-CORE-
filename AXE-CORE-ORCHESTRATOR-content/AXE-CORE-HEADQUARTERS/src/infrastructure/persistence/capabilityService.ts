...
const FALLBACK_CAPABILITIES: CapabilityConfig[] = [
  ...
  { capability: 'analysis',  display_name: 'Analysis',  description: '', preferred_provider: 'openrouter',  preferred_model: 'anthropic/claude-3.5-sonnet',    fallback_provider: 'ollama',     fallback_model: 'llama3.1:8b-32k',                  preferred_agent: '', fallback_agent: '', execution_mode: 'read',    cost_priority: 30, speed_priority: 30, quality_priority: 100, privacy_required: false, stream_required: true, keyword_patterns: ['analys','research','strateg','compare','architect','roadmap'], enabled: true },
