      ...
      <motion.div variants={iv} className="flex-1 min-h-0">
        ...
        >
          ...
          <div className="absolute top-4 right-4 z-10 flex items-center gap-1.5">
            <button onClick={() => setAwarenessOpen(v => !v)} className="rounded-full px-3 py-1.5 text-[10px] font-medium" style={{background: awarenessOpen ? 'rgba(34,211,238,.18)' : 'rgba(34,211,238,.06)', border:'1px solid rgba(34,211,238,.3)', color:'var(--accent-cyan)'}}>Awareness</button>
          ...
          {awarenessOpen && <AwarenessCenter onClose={() => setAwarenessOpen(false)} onApprove={(proposal) => { void voice.sendMessage(`Pak dit awareness-signaal op: ${proposal.context}. Prioriteit: ${proposal.priority}. Vraag opnieuw expliciete goedkeuring voor elke externe of blijvende actie.`); }} />}
