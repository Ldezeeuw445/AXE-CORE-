...
import BookmarkPanel from '@/presentation/components/browser/BookmarkPanel';
import HistoryPanel from '@/presentation/components/browser/HistoryPanel';
import DownloadPanel from '@/presentation/components/browser/DownloadPanel';
