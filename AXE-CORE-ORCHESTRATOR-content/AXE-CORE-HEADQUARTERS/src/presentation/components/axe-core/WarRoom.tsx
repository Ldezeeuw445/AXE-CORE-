          ...
          return (
            <button
              ...
              style={{
                ...
                opacity: last || isOrchestrator || active ? 1 : 0.72,
              }}
            >
              <div className="flex items-center gap-2 mb-1">
                <span
                  ...
                  style={{
                    width: 9,
                    height: 9,
                    background: active ? agent.accent : last ? 'var(--border-active)' : 'var(--border-subtle)',
              ...
              <div className="mt-2 pt-2" style={{ borderTop: '1px solid var(--border-subtle)' }}>
                {active ? (
                  ...
                  <p className="text-xs-custom" style={{ color: 'var(--text-muted)' }}>
                    {isOrchestrator ? 'always on' : 'idle — no work yet'}
                  </p>
                )}
              </div>
            </button>
