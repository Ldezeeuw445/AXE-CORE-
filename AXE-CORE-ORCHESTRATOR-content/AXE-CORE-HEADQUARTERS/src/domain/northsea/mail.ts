 ...
 *
 * Gebruikt door:
 *   - de AXE Core viewer / pre-send preview (deze module)
 *   - de bestaande verzendpaden via supabase/northsea/functions/_shared/mail.ts
 *
 * CrewAI schrijft geen HTML en verstuurt niets. Deze module vormt alleen
 * presentatie: HTML + platte-tekst-fallback, plus het splitsen van nieuwe
 * inhoud, handtekening en RFC-geciteerde geschiedenis.
 *
 * De twee bestanden moeten inhoudelijk gelijk blijven.
 */
