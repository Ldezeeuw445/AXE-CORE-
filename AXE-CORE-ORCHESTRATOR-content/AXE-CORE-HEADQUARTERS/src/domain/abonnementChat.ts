 ...
 * ook meteen ving).
 */
export type AgentEngine = 'claude' | 'claude2' | 'claude3' | 'codex' | 'codex2' | 'cursor';
...
export const ALLE_MOTOREN: readonly AgentEngine[] = ['claude', 'claude2', 'claude3', 'codex', 'codex2', 'cursor'] as const;
