 ...
 * ook meteen ving).
 */
export type AgentEngine = 'claude' | 'claude2' | 'claude3' | 'claude4' | 'codex' | 'cursor';
...
export const ALLE_MOTOREN: readonly AgentEngine[] = ['claude', 'claude2', 'claude3', 'claude4', 'codex', 'cursor'] as const;
