...
export const PROVIDER_KEY_CATALOGUE: ProviderInvoer[] = [
  ...
  { id: 'perplexity',  name: 'Perplexity',     icon: 'Compass', accent: '#1FB8A5', placeholder: '(sleutel op de VPS)', defaultModel: 'research',                   docsUrl: 'https://docs.perplexity.ai',              free: false, needsKey: false },
