/**
 * Route table for the authenticated app shell.
 * Single source of truth for path → page mapping; App.tsx only wires it up.
 */
...
export interface AppRoute {
  /** Route path relative to the shell; 'index' renders at '/'. */
  path: string | 'index';
