...
const FALLBACK_CAPABILITIES: CapabilityConfig[] = [
  ...
  { capability: 'creative',  display_name: 'Creative',  description: '', preferred_provider: 'openrouter',  preferred_model: 'anthropic/claude-3.5-sonnet',    fallback_provider: 'google',     fallback_model: 'gemini-2.0-flash',               preferred_agent: 'axe_companion', fallback_agent: '', cost_priority: 40, speed_priority: 50, quality_priority: 90,  privacy_required: false, stream_required: true, keyword_patterns: ['schrijf','write','brainstorm','creative','campaign'], enabled: true },
