...
const FALLBACK_CAPABILITIES: CapabilityConfig[] = [
  ...
  { capability: 'code',      display_name: 'Code',      description: '', preferred_provider: 'openrouter',  preferred_model: 'anthropic/claude-3.5-sonnet',    fallback_provider: 'openrouter', fallback_model: 'deepseek/deepseek-coder',         preferred_agent: '', fallback_agent: '', cost_priority: 30, speed_priority: 40, quality_priority: 100, privacy_required: false, stream_required: true, keyword_patterns: ['\\bcode\\b','debug','function','typescript','javascript','python','react','bug'], enabled: true },
  { capability: 'analysis',  display_name: 'Analysis',  description: '', preferred_provider: 'openrouter',  preferred_model: 'anthropic/claude-3.5-sonnet',    fallback_provider: 'google',     fallback_model: 'gemini-2.0-flash',               preferred_agent: '', fallback_agent: '', cost_priority: 30, speed_priority: 30, quality_priority: 100, privacy_required: false, stream_required: true, keyword_patterns: ['analys','research','strateg','compare','architect','roadmap'], enabled: true },
  { capability: 'reasoning', display_name: 'Reasoning', description: '', preferred_provider: 'openrouter',  preferred_model: 'openai/gpt-4o',                  fallback_provider: 'anthropic',  fallback_model: 'claude-3-5-sonnet-20241022',     preferred_agent: '', fallback_agent: '', cost_priority: 30, speed_priority: 40, quality_priority: 100, privacy_required: false, stream_required: true, keyword_patterns: ['calculate','bereken','redeneer','what if','why does'], enabled: true },
  { capability: 'privacy',   display_name: 'Privacy',   description: '', preferred_provider: 'ollama',      preferred_model: 'llama3.2',                       fallback_provider: 'ollama',     fallback_model: 'llama3.2',                       preferred_agent: '', fallback_agent: '', cost_priority: 50, speed_priority: 50, quality_priority: 60,  privacy_required: true,  stream_required: true, keyword_patterns: ['password','wachtwoord','private','secret','geheim','bsn','pincode'], enabled: true },
  ...
  { capability: 'trading',   display_name: 'Trading',   description: '', preferred_provider: 'openrouter',  preferred_model: 'anthropic/claude-3.5-sonnet',    fallback_provider: 'openrouter', fallback_model: 'meta-llama/llama-3.1-8b-instruct:free', preferred_agent: '', fallback_agent: '', cost_priority: 50, speed_priority: 60, quality_priority: 90, privacy_required: false, stream_required: true, keyword_patterns: ['trade','market','signal','forex','crypto','stock','risk','leverage'], enabled: true },
  { capability: 'research',  display_name: 'Research',  description: '', preferred_provider: 'openrouter',  preferred_model: 'anthropic/claude-3.5-sonnet',    fallback_provider: 'google',     fallback_model: 'gemini-2.0-flash',               preferred_agent: '', fallback_agent: '', cost_priority: 30, speed_priority: 30, quality_priority: 100, privacy_required: false, stream_required: true, keyword_patterns: ['research','zoek op','find out','what is','who is'], enabled: true },
];
